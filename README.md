...
2. [Download](https://github.com/n0kk/tf2basehud/archive/815f54194be26ead01f78ad2c0b40e7e10cd0d95.zip) the compatible TF2 default HUD (or any other HUD from before Jungle Inferno). Make sure you make an `info.vdf` file to load the HUD (`hud{ui_version 1}`)
