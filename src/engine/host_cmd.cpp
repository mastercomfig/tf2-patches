...
ConVar sv_allow_voice_from_file( "sv_allow_voice_from_file", "0", FCVAR_REPLICATED, "Allow or disallow clients from using voice_inputfromfile on this server.", &voiceconvar_file_changed_f );
