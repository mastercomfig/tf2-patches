...
public:
	...
	bool EnumerateNode( int node, Ray_t const& ray, float f, intptr_t context )
	{
	...
	virtual bool EnumerateLeaf( int leaf, Ray_t const& ray, float start, float end, intptr_t context )
	{
		bool hit = false;
